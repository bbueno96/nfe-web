...
const _calculateEaster = year => {
  ...
  return parseISO(easterDate)
}

const _calculateCorpusChristi = easterDate => {
  return addDays(easterDate, Number('60'))
}

const _calculateCarnival = easterDate => {
  return addDays(easterDate, Number('-47'))
}

const _calculateGodsFriday = easterDate => {
  return addDays(easterDate, Number('-2'))
}
...
const getNationalHolidays = year => {
  ...
  return [
    ...
    {
      date: parseISO(`${String(year)}-01-01`),
      description:
    ...
    {
      date: parseISO(`${String(year)}-05-01`),
      description:
    ...
    {
      date: parseISO(`${String(year)}-09-07`),
      description:
    ...
    {
      date: parseISO(`${String(year)}-10-12`),
      description:
    ...
    {
      date: parseISO(`${String(year)}-11-02`),
      description:
    ...
    {
      date: parseISO(`${String(year)}-11-15`),
      description:
    ...
    {
      date: parseISO(`${String(year)}-12-25`),
      description:
...
export function isNationalHoliday(givenDate: Date) {
