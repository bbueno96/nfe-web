...
export const BankRemittanceForm = () => {
  ...
  const [bankRemittance, setBankRemittance] = useState<BankRemittanceFormValues>()
                              ...
                              <div className="row">
                                ...
                                <div className="col-lg">
                                  <Field label="Data Inicial do Vencimento">
                                    <DateInput
                                      disabled={false}
                                      onChange={minCreatedAtDate =>
                                        filter.setValues(prev => ({ ...prev, minCreatedAtDate }))
                                      }
                                      value={
                                ...
                                <div className="col-lg">
                                  <Field label="Data Final do Vencimento">
                                    <DateInput
                                      disabled={false}
                                      onChange={maxCreatedAtDate =>
                                        filter.setValues(prev => ({ ...prev, maxCreatedAtDate }))
                                      }
                                      value={
